...
/**
 * Servlet implementation class NavigationServlet. This servlet class navigates the user to the appropriate page based on the operation chosen to be performed for each season record.
 */
...
public class SeasonsNavigationServlet extends HttpServlet {
	...
	/**
	 * This method determines what should be done when the user either presses the "delete" or "edit" button.
